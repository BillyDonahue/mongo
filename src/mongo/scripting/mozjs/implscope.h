...
public:
    explicit MozJSImplScope(MozJSScriptEngine* engine, std::optional<int> jsHeapLimitMB);
    ~MozJSImplScope();
...
private:
    ...
    struct MozRuntime {
    public:
        MozRuntime(const MozJSScriptEngine* engine, std::optional<int> jsHeapLimitMB);
