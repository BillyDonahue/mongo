...
public:
     ...
     */
    std::optional<std::vector<OplogEntry>> updateSession(const OplogEntry& entry);
...
private:
     ...
     */
    std::optional<std::vector<OplogEntry>> _updateOrFlush(const OplogEntry& entry);

    /**
     * Returns an update to the transaction table generated by a transaction operation. This returns
     * std::nullopt if the operation is a partialTxn operation that is not the first of the
     * transaction.
     */
    std::optional<OplogEntry> _createTransactionTableUpdateFromTransactionOp(
