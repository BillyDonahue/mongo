...
TEST_F(FreeMonStorageTest, TestClusterManagerStorage) {
    ...
    ASSERT_FALSE(FreeMonStorage::readClusterManagerState(_opCtx.get()));
    ...
    ASSERT_TRUE(FreeMonStorage::readClusterManagerState(_opCtx.get()));
