...
#define DEATH_TEST(SUITE_NAME, TEST_NAME, MATCH_EXPR) \
    DEATH_TEST_(                                      \
        SUITE_NAME, TEST_NAME, MATCH_EXPR, UNIT_TEST_DETAIL_TEST_TYPE_NAME(SUITE_NAME, TEST_NAME))
#define DEATH_TEST_(SUITE_NAME, TEST_NAME, MATCH_EXPR, TEST_TYPE)                              \
...
#define DEATH_TEST_F(FIXTURE_NAME, TEST_NAME, MATCH_EXPR) \
    DEATH_TEST_F_(FIXTURE_NAME,                           \
                  TEST_NAME,                              \
                  MATCH_EXPR,                             \
                  UNIT_TEST_DETAIL_TEST_TYPE_NAME(FIXTURE_NAME, TEST_NAME))
#define DEATH_TEST_F_(FIXTURE_NAME, TEST_NAME, MATCH_EXPR, TEST_TYPE)                          \
...
public:
    ...
    //    explicit DeathTest(Args&&... args) : DeathTestBase([args...] { return
