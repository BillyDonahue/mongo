...
private:
     ...
     */
    void queueUnlock(const DistLockHandle& lockSessionID, const std::optional<std::string>& name);
    ...
    std::deque<std::pair<DistLockHandle, std::optional<std::string>>> _unlockList;  // (M)
