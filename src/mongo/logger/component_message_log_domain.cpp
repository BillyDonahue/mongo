...
bool ComponentMessageLogDomain::shouldLog(logv2::LogComponent component, logv2::LogSeverity severity) const {
...
logv2::LogSeverity ComponentMessageLogDomain::getMinimumLogSeverity(logv2::LogComponent component) const {
